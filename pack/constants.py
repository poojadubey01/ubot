...
fr=Style.NORMAL
fr=Fore.RED
animation=[fy+fr+'[■□□□□□□□□□]',fy+fr+'[■■□□□□□□□□]',fy+fr+'[■■■□□□□□□□]',fy+fr+'[■■■■□□□□□□]',fy+fr+'[■■■■■□□□□□]',fy+fr+'[■■■■■■□□□□]',fy+fr+'[■■■■■■■□□□]',fy+fr+'[■■■■■■■■□□]',fy+fr+_A,fy+fr+_A,fy+fr+'[■■■■■■■■■■]']
...
total_sites=[fy+fr+'Discudemy',fy+fr+'Udemy Freebies',fy+fr+'Udemy Coupons',fy+fr+'Real Discount',fy+fr+'Tricks Info',fy+fr+'Free Web Cart',fy+fr+'Course Mania',fy+fr+'Jojo Coupons',fy+fr+'Online Tutorials']
